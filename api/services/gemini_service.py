...
class GeminiService:
    ...
    async def analyze_exercise(self, description: str, user_weight_kg: Optional[float] = None) -> ExerciseAnalysisResult:
    ...
    async def correct_exercise_analysis(self, previous_result: ExerciseAnalysisResult, user_comment: str) -> ExerciseAnalysisResult:
