...
from api.models.food_analysis import FoodAnalysisResult, FoodAnalysisRequest, FoodCorrectionRequest
...
@router.get("/optional-auth-example", summary="Optional authentication example", tags=["Examples"])
