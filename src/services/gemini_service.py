...
from src.services.gemini.exceptions import GeminiServiceException, GeminiAPIKeyMissingError
from src.services.gemini.food_service import FoodAnalysisService
from src.services.gemini.exercise_service import ExerciseAnalysisService
...
class GeminiService:
    ...
    async def analyze_food_by_text(self, description: str):
    ...
    async def analyze_food_by_image(self, image_file):
    ...
    async def analyze_nutrition_label(self, image_file, servings: float = 1.0):
    ...
    async def correct_food_analysis(self, previous_result, user_comment: str):
    ...
    async def analyze_exercise(self, description: str, user_weight_kg: Optional[float] = None):
    ...
    async def correct_exercise_analysis(self, previous_result, user_comment: str):
